...
DEFAULT_STRATEGY_TRANSLATE = config('DEFAULT_STRATEGY_TRANSLATE')
OPENAI_API_KEY = config('OPENAI_API_KEY')
LIBRETRANSLATE_HOSTNAME = config('LIBRETRANSLATE_HOSTNAME')
LIBRETRANSLATE_PORT = config('LIBRETRANSLATE_PORT')
